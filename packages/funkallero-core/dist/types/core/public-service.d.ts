...
export type PublicServiceRegister = {
    readonly registerScopedService: <TKey extends string, TService extends Constructor<IScopedService>>(serviceKey: TKey, service: ScopedServiceResult<TService, TKey>) => void;
    readonly registerSingletonService: <TKey extends string, TService extends Constructor<ISingletonService>>(serviceKey: TKey, service: NonNullable<SingletonServiceResult<TService, TKey, true>>) => void;
};
